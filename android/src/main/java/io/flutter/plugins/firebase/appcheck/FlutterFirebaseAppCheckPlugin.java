              ...
              case debugProvider:
                {
                  ...
                  // Check if a custom debug token is provided
                  String customDebugToken = (String) arguments.get("customDebugToken");
                  if (customDebugToken != null && !customDebugToken.isEmpty()) {
                    // Use the custom debug token
                    firebaseAppCheck.installAppCheckProviderFactory(
                        DebugAppCheckProviderFactory.getInstance(customDebugToken));
                  } else {
                    // Use the default debug provider
                    firebaseAppCheck.installAppCheckProviderFactory(
