...
Pod::Spec.new do |s|
  ...
  s.source           = { :path => '.' }
  s.source_files     = ['firebase_app_check/Sources/firebase_app_check/**/*.{h,m}', 'Classes/**/*.{h,m}']
  s.private_header_files = 'firebase_app_check/Sources/firebase_app_check/include/*.h'
