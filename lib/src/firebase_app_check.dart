...
class FirebaseAppCheck extends FirebasePluginPlatform {
  ...
  ///
  /// If using the debug provider, you can specify a custom debug token by setting the `customDebugToken` parameter.
  /// Alternatively, you can set the DEBUG_APP_CHECK_TOKEN environment variable.
  /// If both are provided, the `customDebugToken` parameter takes precedence.
  ///
